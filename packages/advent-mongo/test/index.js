...
const MONGO_URL = 'mongodb://localhost:27017/eventstream-test'

describe('advent-mongodb', () => {
  before(async () => {
    engine = createEngine(MONGO_URL)
  })
  ...
  describe('save', () => {
    it('should save events', async () => {
      ...
      should(events.length).eql(data.length)
  ...
  describe.skip('load', () => {
    ...
    it.skip('should load events by id', async () => {
      const testEvents = [
        ...
        { entity: { id: 'a5', name: 'test' }, type: 'tested', payload: { a: 4 } },
        { entity: { id: 'a6', name: 'test' }, type: 'tested', payload: { a: 5 } }
      ]
    ...
    it.skip('should load events from snapshot', async () => {
      const testEvents = [
        ...
        { entity: { id: 'a2', name: 'test' }, type: 'tested', payload: { a: 3 } },
        { entity: { id: 'a2', name: 'test' }, type: 'tested', payload: { a: 4 } },
        { entity: { id: 'a2', name: 'test' }, type: 'tested', payload: { a: 5 } }
      ]

      const snapshot = { id: 'a2', a: 3, version: 2, revision: 2 }
